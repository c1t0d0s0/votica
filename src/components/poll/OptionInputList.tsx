        ...
        {options.map((opt, index) => (
          ...
          >
            ...
            <input
              ...
              className="flex-1 text-sm bg-white px-3 py-2 rounded-lg border border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 focus:outline-none transition-all"
            />
